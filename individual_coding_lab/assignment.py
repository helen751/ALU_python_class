...
class Assignment:
    ...
    def add_new_assignment(self):
        ...
        if assignment_category_option == "1":
            ...
            return #to stop the program and handle this error
    ...
    def delete_assignment(self):
        ...
        #calling the serach assignment function to check if the assignment exist in the dictionary.
        ...
        if confirm.lower == "yes" or confirm.lower() == "y":
            del self.assignments_dict[category][index]  # don't increment i here
